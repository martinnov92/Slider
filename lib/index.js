...
var Slider = (function () {
    ...
    Slider.prototype.init = function () {
        ...
        this.store.forEach(function (child) {
            ...
            if (_this.settings.itemsPerSlide !== undefined) {
                dividedBy = _this.settings.itemsPerSlide;
            }
            child.element.style.width =
                Math.round(_this.dimensionOfParent.width / dividedBy) + 'px';
    ...
    Slider.prototype.next = function () {
        ...
        var nextActive = this.store[indexOfActiveElement + scrollBy];
    ...
    Slider.prototype.prev = function () {
        ...
        var currentActive = this.store[indexOfActiveElement];
        var prevActive = this.store[indexOfActiveElement - 1 - scrollBy];
    ...
    Slider.prototype.sliderDimension = function () {
        ...
        this.store.forEach(function (child) {
            ...
            child.element.style.width =
                Math.ceil(_this.dimensionOfParent.width / dividedBy) + 'px';
        });
        this.moveSlide(this.store[findIndex(this.store, 'active')].element.offsetLeft);
    };
