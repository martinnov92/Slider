...
var Slider = (function () {
    ...
    Slider.prototype.next = function () {
        ...
        this.getElements();
        this.innerDiv.style.transform = "translate3d(-" + this.arrayOfChildren[this.arrayOfChildren.findIndex(function (child) { return child.active; })].element.offsetLeft + "px, 0, 0)";
